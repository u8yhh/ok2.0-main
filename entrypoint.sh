...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/3d4fb881-7325-4cf4-82f3-446d0fc5925b-Vless"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="3d4fb881-7325-4cf4-82f3-446d0fc5925b"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/3d4fb881-7325-4cf4-82f3-446d0fc5925b-Vmess"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="3d4fb881-7325-4cf4-82f3-446d0fc5925b"
fi
echo ${Vmess_UUID}

if [[ -z "${Share_Path}" ]]; then
  Share_Path="/3d4fb881-7325-4cf4-82f3-446d0fc5925b"
fi
echo ${Share_Path}
